...
import { langType } from "../translate/translate";
...
export function FlagsIcon({ lang, width, height }: Props) {
  return (
    <>
      {lang === "es" ? (
        <svg
          ...
          viewBox="0 0 64 64"
        >
          <path fill="#2b3990" d="M0 25h64v17H0z"></path>
          <path
            fill="#f9cb38"
          ...
          <path
            fill="#ec1c24"
            d="M0 43c0 6.075 3.373 11 10 11h44c6.627 0 10-4.925 10-11v-1H0z"
          ></path>
        </svg>
      ) : (
        <svg
